...
<section id="scrolly-two" class="my-8 relative grid">
    <article class="w-full relative px-2 space-y-32">
        <div class="step relative z-1 w-96 p-4 flex flex-col gap-4 text-justify lg:right-[30vw] xl:right-[35vw]" data-step="1">
            <p>This is Oakland.</p>
        ...
        <div class="step relative z-1 w-96 p-4 flex flex-col gap-4 text-justify lg:left-[30vw] xl:left-[35vw]" data-step="2">
        ...
        <div class="step relative z-1 w-96 p-4 flex flex-col gap-4 text-justify lg:right-[30vw] xl:right-[35vw]" data-step="3">
        ...
        <div class="step relative z-1 w-96 p-4 flex flex-col gap-4 text-justify lg:left-[30vw] xl:left-[35vw]" data-step="3">
        ...
        <div class="step relative z-1 w-96 p-4 flex flex-col gap-4 text-justify lg:right-[30vw] xl:right-[35vw]" data-step="4">
        ...
        <div class="step relative z-1 w-96 p-4 flex flex-col gap-4 text-left lg:left-[30vw] xl:left-[35vw]" data-step="5">
        ...
        <div class="step relative z-1 w-96 p-4 flex flex-col gap-4 text-justify lg:right-[30vw] xl:right-[35vw]" data-step="6">
        ...
        <div class="step relative z-1 w-96 p-4 flex flex-col gap-4 text-justify lg:left-[30vw] xl:left-[35vw]" data-step="7">
