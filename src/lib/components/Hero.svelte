...
<div class="w-screen h-screen flex flex-col gap-8 sm:gap-12 items-center justify-center border-box background text-[#dcd3ca]">
    ...
    <p class="md:fixed md:bottom-4 md:text-black lg:hidden">Please view this on a laptop or bigger screen (&ge;1024px).</p>
</div>
...
<style>
    ...
    @media (min-width: 640px) {
        .content {
            box-shadow: 16px 16px oklch(70.4% 0.191 22.216);
        }
    }
    .content {
        border-radius: 2rem;
